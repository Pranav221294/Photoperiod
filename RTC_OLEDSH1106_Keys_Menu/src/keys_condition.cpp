...
bool programmingHour = false;
bool programmingMinute = false;
bool programmingSecond = false;
bool programmingDuration = false;
...
//   SET_VARIABLES.SET_START_CLK_HRS = preferences.getInt("SET_START_CLK_HRS", 0);
//   SET_VARIABLES.SET_START_CLK_MIN = preferences.getInt("SET_START_CLK_MIN", 0);
//   SET_VARIABLES.SET_START_CLK_SEC = preferences.getInt("SET_START_CLK_SEC", 0);
//   SET_VARIABLES.SET_STOP_CLK_HRS = preferences.getInt("SET_START_CLK_HRS", 0);
//   SET_VARIABLES.SET_STOP_CLK_MIN = preferences.getInt("SET_START_CLK_MIN", 0);
//   SET_VARIABLES.SET_STOP_CLK_SEC = preferences.getInt("SET_START_CLK_SEC", 0);
...
LIVE_VARIABLES.SET_STOP_CLK_HRS = SET_VARIABLES.SET_STOP_CLK_HRS;
LIVE_VARIABLES.SET_STOP_CLK_MIN = SET_VARIABLES.SET_STOP_CLK_MIN;
...
String StophourStr = (LIVE_VARIABLES.SET_STOP_CLK_HRS < 10) ? "0" + String(LIVE_VARIABLES.SET_STOP_CLK_HRS) : String(LIVE_VARIABLES.SET_STOP_CLK_HRS);
String StopminuteStr = (LIVE_VARIABLES.SET_STOP_CLK_MIN < 10) ? "0" + String(LIVE_VARIABLES.SET_STOP_CLK_MIN) : String(LIVE_VARIABLES.SET_STOP_CLK_MIN);
...
String StoptimeString = StophourStr + ':' + StopminuteStr + ':' + StopsecondStr;
...
void key_pressing_func()
{
  ...
  // {
  //   currentMode = PROGRAMMING_MODE;
  //   programmingHour = true;
  //   programmingMinute = false;
  //   programmingSecond = false;
 ...
 if (Ent_Button.isPressed() && currentMode == PROGRAMMING_MODE) 
 {
    switch (setting) 
    {
        ...
        case START_CLK_MIN:
            ...
            setting = START_CLK_SEC;
            break;
        case START_CLK_SEC:
            // Handle programming for START_CLK_SEC
            setting = STOP_CLK_HRS;
            break;
        case STOP_CLK_HRS:
            // Handle programming for START_CLK_HRS
            setting = STOP_CLK_MIN;
            break;
        case STOP_CLK_MIN:
            // Handle programming for START_CLK_MIN
   ...
   // Check for continuous increment
...
SET_VARIABLES.SET_STOP_CLK_HRS = preferences.getInt("STOP_HRS", 0); // Corrected key
SET_VARIABLES.SET_STOP_CLK_MIN = preferences.getInt("STOP_MIN", 0); // Corrected key
...
//   preferences.putInt("SET_START_CLK_HRS", SET_VARIABLES.SET_START_CLK_HRS);
//   preferences.putInt("SET_START_CLK_MIN", SET_VARIABLES.SET_START_CLK_MIN);
//   preferences.putInt("SET_START_CLK_SEC", SET_VARIABLES.SET_START_CLK_SEC);
//   preferences.putInt("SET_STOP_CLK_HRS", SET_VARIABLES.SET_STOP_CLK_HRS);
//   preferences.putInt("SET_STOP_CLK_MIN", SET_VARIABLES.SET_STOP_CLK_MIN);
//   preferences.putInt("SET_STOP_CLK_SEC", SET_VARIABLES.SET_STOP_CLK_SEC);
preferences.putInt("START_HRS", SET_VARIABLES.SET_START_CLK_HRS);
  ...
  preferences.putInt("STOP_HRS", SET_VARIABLES.SET_STOP_CLK_HRS);
  preferences.putInt("STOP_MIN", SET_VARIABLES.SET_STOP_CLK_MIN);
